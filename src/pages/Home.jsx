		...
		<>
			...
			<div className="w-full mx-auto h-screen relative  ">
				...
				<div className="w-full h-[90%]  sm:flex-row flex-col-reverse flex ">
					<div className=" w-[18%] sm:flex hidden aspect-square top-32 absolute z-[50] bg-gray-400 left-[51%]  items-center justify-center">
						<img src={profile} alt="" className="bg-center w-full h-full" />
					</div>
					<div className=" w-[18%] sm:flex hidden aspect-square  top-36 absolute z-[10] bg-transparent border-2 left-[52%]  items-center justify-center border-white"></div>
					<div className="sm:w-3/5 w-full  bg-blue-900  h-[80%] sm:h-full  ">
						...
						">
							...
							<text className="text-xl text-white  mt-28 text-center sm:text-left  sm:mt-4">	Hey, I'm Dhanushka Basnayaka</text>
							<text className="sm:w-[80%] text-white mt-4 text-justify w-full sm:text-left px-4 sm:px-0">	A Result-Oriented Web Developer building and managing Websites and Web Applications that leads to the success of the overall product</text>
							...
							<div className="  w-full items-center sm:justify-start justify-center mt-8 sm:mt-0 flex  gap-x-4">
								<a href="DhanushkaBasnayaka.pdf" target="DhanushkaBasnayaka.pdf" className="sm:mt-8 w-auto lg:px-20 rounded text-white text-center justify-center items-center gap-x-1 flex lg:text-lg text-base px-8  py-1 lg:py-2 text hover:bg-blue-700  hover:border-blue-500 hover:text-white border uppercase">
									Resume
					...
					<div className="sm:w-2/5 w-full gap-x-4 border-black sm:flex flex-col justify-start  px-4 border items-start pt-16 flex bg-[#c9f07b] sm:h-full h-[32%] ">
						<div className="flex mt-4  gap-x-2 sm:hidden">

							<text className=" text-blue-700  text-4xl sm:text-6xl font-bold">Full-stack</text>
							<text className=" text-blue-700   text-4xl sm:text-6xl  font-bold">Developer.</text>
						</div>
						<div className=" w-[50%] sm:hidden flex aspect-square  mx-auto mt-6 bg-gray-400   items-center justify-center">
							<img src={profile} alt="" className="bg-center w-full h-full" />
						</div>
